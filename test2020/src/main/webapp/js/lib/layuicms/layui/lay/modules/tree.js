...
layui.define("form", function (e) {
	...
	b.prototype.checkClick = function (e, a) {
		...
		l.on('click', 'input[same="layuiTreeCheck"]+', function (r) {
			...
			var l = i(this).prev(),
			c = l.prop("checked");
			l.prop("disabled") || ((typeof t.cascade === 'boolean' && !t.cascade) || n.setCheckbox(e, a, l), 
				t.oncheck && t.oncheck({
					elem: e,
					checked: c,
					data: a
	...
	b.prototype.operate = function (e, a) {
		...
		l.children(".layui-tree-btnGroup").on("click", ".layui-icon", function (l) {
			...
			if ("add" == f) {
				if(r.add && typeof r.add === 'function'){
					r.add(g);
				}else{
	...
	b.prototype.getCheckedArray = function () {
		var e = this,
		a = e.config,
		n = [],
		t = [];
		e.elem.find(".layui-form-checked").each(function () {
			var id = i(this).prev()[0].value;
			var data = e.getData(id);
			n.push(data);
		});
		return n;
	},
	...
	b.prototype.setDisabled = function (e, b) {
		var a = this;
		a.config;
		b = !!b;
		a.elem.find("." + s).each(function (a, n) {
...
//					return r[0].checked || l.click(), !1
				...
				"object" == typeof e && layui.each(e, function (e, i) {
					if (i == t ){
						r.attr('disabled', b);
						if(b){
							l.addClass('layui-checkbox-disabled layui-disabled');
							m.addClass(' layui-disabled');
						} else {
							l.removeClass('layui-checkbox-disabled layui-disabled');
							m.removeClass(' layui-disabled');
						}
					}
					// return !0
				})
	...
	b.prototype.getData = function(id){
		function getDataRecursion(data, rootId){
			if(data&&data.length>0){
				...
				for(var i = 0; i<data.length; i++){
					...
					if(d.id == rootId){
						...
						ret = getDataRecursion(d.children, rootId);
					}
					if(ret){
						return ret;
					}
		...
		if(typeof id === 'number' || typeof id === 'string'){
			return getDataRecursion(data, id);
		} else {
			return data[0];
		}
	},
	...
	r.getCheckedArray = function (e) {
		var i = l.that[e];
		return i.getCheckedArray()
	},
	r.setChecked = function (e, i) {
		var a = l.that[e];
		return a.setChecked(i)
	},
	r.setDisabled = function (e, i, b) {
		var a = l.that[e];
		return a.setDisabled(i, b)
	},
	r.getData = function (e, i) {
		var a = l.that[e];
		return a.getData(i)
	},
	r.render = function (e) {
